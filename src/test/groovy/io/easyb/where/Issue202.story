...
println "${testSourceDir}/groovy/io/easyb/where/Issue202Example.story"

scenario "txt report are bugged with where clause",{
	given "a story with 1 scenario with 1 where containing 2 values",{

		specBehavior = BehaviorFactory.createBehavior(new File("${testSourceDir}/groovy/io/easyb/where/Issue202Example.story"))
	}
